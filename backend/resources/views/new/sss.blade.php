...
@section('content')
    <!-- Page Inner Start -->
    <div class="cs-sss-main">
        <h5 class="cs-title1">Merak edilen sorular?</h5>
        <h6 class="cs-title2">Mimarlar ve Mühendislerimizi bir araya toplamakla kalmadık, bir de sıkça sorulan
            sorular alanı yaptık!
        </h6>
                ...
                <div class="card-header" id="headingOne">
                    <h5 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne"
                            ...
                            Nasıl teklif formu oluşturabilirim?
                        </button>
                    </h5>
                </div>
                ...
                <div class="card-header" id="headingTwo">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                            ...
                            Nasıl cari hesap extrelerimi görüntüleyebilirim?
                        </button>
                    </h5>
                </div>
                ...
                <div class="card-header" id="headingFour">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                            ...
                            Nasıl havuza proje oluşturabilirim?
                        </button>
                    </h5>
                </div>
