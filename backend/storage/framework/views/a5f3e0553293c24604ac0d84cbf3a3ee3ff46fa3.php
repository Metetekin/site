...
} elseif ($_instance->childHasBeenRendered('XK5XOv1')) {
    $componentId = $_instance->getRenderedChildComponentId('XK5XOv1');
    $componentTag = $_instance->getRenderedChildComponentTagName('XK5XOv1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XK5XOv1');
} else {
    $response = \Livewire\Livewire::mount('page-builder.footer-block', ['pageId' => $footer_settings['page_id'],'blockKey' => $footer_settings['block_key'],'styleCss' => $footer_settings['style_css'],'siteView' => true,'page_id' => $footer_settings['page_id'],'block_key' => $footer_settings['block_key'],'settings' => $footer_settings['settings'],'style_css' => $footer_settings['style_css'],'site_view' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('XK5XOv1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php /**PATH C:\wamp\www\taskup\backend\resources\views/errors/minimal.blade.php ENDPATH**/ ?>