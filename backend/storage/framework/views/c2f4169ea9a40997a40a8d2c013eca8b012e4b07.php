...
} elseif ($_instance->childHasBeenRendered('bOJ9Luz')) {
    $componentId = $_instance->getRenderedChildComponentId('bOJ9Luz');
    $componentTag = $_instance->getRenderedChildComponentTagName('bOJ9Luz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bOJ9Luz');
} else {
    $response = \Livewire\Livewire::mount('page-builder.footer-block', ['pageId' => $footer_settings['page_id'],'blockKey' => $footer_settings['block_key'],'styleCss' => $footer_settings['style_css'],'siteView' => true,'page_id' => $footer_settings['page_id'],'block_key' => $footer_settings['block_key'],'settings' => $footer_settings['settings'],'style_css' => $footer_settings['style_css'],'site_view' => true]);
    $html = $response->html();
    $_instance->logRenderedChild('bOJ9Luz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
<?php /**PATH C:\wamp\www\taskup\backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>