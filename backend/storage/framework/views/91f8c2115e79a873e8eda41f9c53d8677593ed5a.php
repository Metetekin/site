...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('B87Llan')) {
    $componentId = $_instance->getRenderedChildComponentId('B87Llan');
    $componentTag = $_instance->getRenderedChildComponentTagName('B87Llan');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('B87Llan');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('B87Llan', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('k0oHuKH')) {
    $componentId = $_instance->getRenderedChildComponentId('k0oHuKH');
    $componentTag = $_instance->getRenderedChildComponentTagName('k0oHuKH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('k0oHuKH');
} else {
    $response = \Livewire\Livewire::mount('earnings.invoices', ['className' => 'tk-dbinvoice']);
    $html = $response->html();
    $_instance->logRenderedChild('k0oHuKH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('1RDGaGO')) {
    $componentId = $_instance->getRenderedChildComponentId('1RDGaGO');
    $componentTag = $_instance->getRenderedChildComponentTagName('1RDGaGO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1RDGaGO');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('1RDGaGO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app',['include_menu' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\taskup\backend\resources\views/front-end/dashboard/dashboard.blade.php ENDPATH**/ ?>